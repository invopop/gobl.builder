...
export class JSONWorker {
  ...
  async getColorPresentations(
    ...
    const jsonDocument = this._languageService.parseJSONDocument(document);
    const colorPresentations = this._languageService.getColorPresentations(document, jsonDocument, color, range);
...
export function create(ctx: monaco.worker.IWorkerContext, createData: ICreateData): JSONWorker {
